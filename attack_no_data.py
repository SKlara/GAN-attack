...
class CGAN():
    ...
    def train(self, epochs, n):
        ...
        for epoch in range(epochs):
            ...
            fake_labels = np.random.randint(0, 3, (batch_size, 1)).reshape(-1, 1)
            ...
            d_loss = self.discriminator.train_on_batch([gen_imgs, fake_labels], gen_labels)
    ...
    def sample_images(self, n, epoch):
        ...
        for i in range(r):
            for j in range(c):
                ...
                axs[i,j].axis('off')
                cnt += 1
        fig.savefig("attack_images/images_25/%d_%d.png" % (n, epoch))
        plt.close()
...
class Adversary():
    ...
    def train(self, epochs, n):
        ...
        self.discriminator.train(epochs, gen_imgs, fake_labels, gen_imgs, fake_labels)
